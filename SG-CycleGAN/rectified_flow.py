...
class RectifiedFlow:
    ...
    def mse_loss(self, v, x_1, x_0):
        ...
        # batch_size = x_1.size(0)  / batch_size

        # ground = x_1 - x_0
        # max_value = torch.max(ground)
        # print(f"向量 ground 的最大值: {max_value.item()}")

        # loss = F.mse_loss(ground, v, reduction='mean')
        criterion = nn.SmoothL1Loss()
        loss = criterion(x_1 - x_0, v)
