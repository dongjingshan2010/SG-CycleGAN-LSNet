...
class SharedGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, image_size, depth4vit, n_residual_blocks=3, shared_layers=4):
        ...
        heads = 8
        dropout = 0.1
        self.transformer = Transformer(dim, depth, heads, dim, dropout, image_size, patch_size)

        self.to_cls_token = nn.Identity()
        self.decoder = ViTToImageDecoder(img_size=image_size, patch_size=patch_size, embed_dim=dim, out_channels=3)
